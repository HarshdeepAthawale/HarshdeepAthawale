...
- **35+ vulnerabilities** reported across Flipkart, NASA, OPPO, Netflix, Adobe, Coca-Cola, Superdrug, Anduril Industries, Goldman Sachs, Nvidia on HackerOne, Bugcrowd & Intigriti
- **4 bugs accepted** on NASA's program via Bugcrowd
- **Transformer-based WAF** built from scratch using DistilBERT-98.5% attack detection (2.16x better than ModSecurity CRS v4) on 675 real-world payloads across 10 attack categories
- **Top 1% worldwide** on TryHackMe (17K rank, 200+ labs, 270+ day streak)

Your security is only as strong as the bug I haven't found yet 👾
